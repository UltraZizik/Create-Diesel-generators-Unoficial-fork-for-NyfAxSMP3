...
public class HammeringCategory extends CreateRecipeCategory<HammerRecipe> {
    ...
    @Override
    public void draw(HammerRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics graphics, double mouseX, double mouseY) {
        ...
        renderedHammer.set(CDGDataComponents.PROCESSING_ITEM, new SandPaperItemComponent(matchingStacks[0]));
