...
Adding Diesel Generators ( and more stuff ) to the <a href="https://www.curseforge.com/minecraft/mc-mods/create">Create</a> mod.<br><br>This is an UNOFFICIAL fork of the mod. If any issues report to the original author because this is mainly for NyfAxSMP3 server and modpack and IT does not ADD any new things just a compatibility layer with Immersive petroleum mod and deletes the original things. THANKS FOR UNDERSTANDING <br> <i>the title logo was made by DAXXXZ_NORT_2077</i>
<br><br><br><br>
